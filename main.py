...
def get_all_gear_links():
    ...
    elements_to_parse.append((url, parse_5))
...
def get_all_items_links():
    ...
    elements_to_parse.append((url, parse_4))
...
if __name__ == '__main__':
    ...
    get_all_items_links()
    main()
    print(f"Parsing_results len: {len(parsing_results)}")
